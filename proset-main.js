...
class Proset {
  ...
  Init() {
    ...
    window.addEventListener("touchstart", this.difficultyListener);
  }
  ...
  keyStartGame(event) {
    ...
    window.removeEventListener("touchstart", this.difficultyListener);
  }
  ...
  startGame(difficulty) {
    ...
    for (let startSlot of this.slots) {
      ...
      startSlot.slot.addEventListener("mousedown", e =>
    ...
    if (typeof this.keyListener === "undefined") {
      ...
      window.addEventListener("touchstart", this.keyListener);
    }
